...
public class NoticeUpdateFormController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Notice n = new NoticeService().selectDetailNotice(UJnoticeNo);
		
		request.setAttribute("n", n);
		request.getRequestDispatcher("views/notice/noticeUpdatesemi.jsp").forward(request, response);
		
		// 공지사항 업데이트 폼 추가하고 거기로 쏘기
