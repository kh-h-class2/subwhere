	...
	<%@page import="com.kh.uploadFile.model.vo.uploadFile"%>
...
<body>
    ...
    <div class="UJ-wrap">
        ...
        <div class="UJ-course1" id="UJ-up">
            ...
            <div id="UJ-up-img" style="margin-left :190px;">
                <img src="resources/image/report.png" align="right" style="width: 35px;" id="UJ-report" >
                <img src="resources/image/heart1.png" align="right" style="width: 35px; " id="UJ-like" onclick="UJlikeToggle();">
            </div>
      ...
      <!------------------------------코스 제목------------------------------->
       ...
       <!-- dtn2번부터는 null일 수도 있음  -->          
			...
			<% if (list.size() > 2  && list.get(1).getFilePath() != null) { %>
               ...
               <%}else{ %>
                 <div id="UJ-seq2">
                    ...
                    <div id="UJ-seq2-2">
                        <img src="resources/image/gray.png" >
                    </div>
              ...
              <% if (list.size() > 3  && list.get(2).getFilePath() != null) { %>
            ...
            <% if (list.size() > 4  && list.get(3).getFilePath() != null) { %>
  ...
  <script>
    var Ujh = 1;
    function UJlikeToggle() {
        
        var Ujlike = document.getElementById("UJ-like");
        if(h % 2 == 1) {
            Ujlike.src="resources/image/heart2.png";
        }else {
            Ujlike.src="resources/image/heart1.png";
        }
        Ujh++;
