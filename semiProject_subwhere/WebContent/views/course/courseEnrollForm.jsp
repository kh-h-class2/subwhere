<%@page import="com.kh.board.model.vo.Station"%>
...
<body>
  ...
  <%@ include file="../common/header.jsp" %>
    ...
    <div class="UJ-wrap">
        ...
        <div class="course1" id="up">
            <h2 style="margin-left: 15px; color: gray;"> <b>여행코스 글쓰기</b></h2>
        </div>


   
  <form action="<%=contextPath %>/insert.co" method="post" class="UJ-form" enctype="multipart/form-data">
		<!-- 로그인 멤버 세션을 얻어와서 사용자 번호를 얻어오기 -->
    	<input type="hidden" name="userNo" value ="<%=((Member)request.getSession().getAttribute("loginMember")).getMemberNo() %>" >
     
        <div class="course2" id="courseTitle-file">
            <div id="courseTitle">
              <input type="text" id="courseTitle" name="courseTitle" placeholder="제목을 입력해주세요." required>
            ...
            <div id="UJ-search_station">
                ...
                <select onclick="UJcategoryChange();" style="height: 36px; width: 170px;" id="UJ-station-line">
                    ...
                    <select id="UJ-stationName" style="height: 36px; width: 150px;" name="UJ-stationName">
        ...
        <div class="course4" id="sequence">
            ...
            <p style="font-size: 17px; color: gray; text-align: center; "> (하단의 사각형 영역을 클릭하여 해당 장소의 사진을 첨부해주세요 . 단, 첫 번째 사진은 필수입니다.)</p>  
                ...
                <div id="seq1">
                    ...
                    <div id="seq1-2">
                        <img id="titleImg1" onclick="clickImg(1);"  >
                    </div>

                    <div id="seq1-3" style="padding-top: 30px;">
                        <input type="text" placeholder="장소명을 입력해주세요" style="width: 350px;" name="DTN_1">
              ...
              <div id="seq2">
                    <div id="seq2-1">2</div>
                    <div id="seq2-2">
                        <img  id="contentImg2" onclick="clickImg(2);">
                    </div>

                    <div id="seq2-3" style="padding-top: 30px;">
              ...
              <div id="seq3">
                    <div id="seq3-1">3</div>
                    <div id="seq3-2">
                        <img  id="contentImg3" onclick="clickImg(3);">
                    </div>

                    <div id="seq3-3" style="padding-top: 30px;">
              ...
              <div id="seq4">
                    <div id="seq4-1">4</div>
                    <div id="seq4-2">
                        <img  id="contentImg4" onclick="clickImg(4);">
                    </div>

                    <div id="seq4-3" style="padding-top: 30px;">
              ...
              function loadImg(file, num){
                    ...
                    if(file.files.length == 1){
                        ...
                        reader.onload = function(e){
                            // e.targer.result => 읽어들인 파일의 고유한 url이 있음 

                            switch(num){
                                case 1 : $("#titleImg1").attr("src",e.target.result); break;
                        ...
                        // 선택된 파일이 취소된 경우 => 미리보기 한 것도 사라지게 하기 
					   // src를 null하면 됨 
					switch(num){
			 		case 1 : $("#titleImg1").attr("src",null); break;
            ...
            <div class="course5" id="courseContent">
            
                <textarea name="courseContent" style="resize: none;" placeholder=" 내용을 입력해주세요."></textarea>
            </div>

            <div class="course6" id="courseTip">
                <textarea name="courseTip" id="UJ-tip" style="resize: none;" placeholder="꿀팁란!! 마음껏 입력해주세요."></textarea>
            </div>

            <div class="course7" id="button">
                <button type="submit" class="btn btn-secondary">작성하기</button>
                <input type="reset" class="btn btn-secondary" value="초기화">
                <button class="btn btn-secondary" onclick="gotoback();" > 뒤로가기</button>
...
<script>
    function gotoback(){
        ...
        location.href="<%=contextPath%>/list.co?cpage=1";
