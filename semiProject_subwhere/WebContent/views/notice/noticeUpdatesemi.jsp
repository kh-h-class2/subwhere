...
<body>
    ...
    <div class="UJ-wrap">
        ...
        <form action="<%=contextPath %>/updateSemi.no" method="post">


			<input type="hidden" name="upNo" value="<%=n.getNoticeNo()%>">

            <div id="UJ-notice-title">
                    <h1>
                        <input type="text" name="noticeTItle" value="<%=n.getNoticeTitle() %>" style="padding-left: 20px; width: 800px;">
        ...
        <div id="UJ-content">
            <p style="padding-left: 100px;">
                <textarea name="noticeContent"  cols="104" rows="15" style="resize: none; padding-left: 15px;"><%=n.getNoticeContent() %></textarea>
            </p>
        ...
        <div id="UJ-btn">
         ...
         <!------------------------------ 수정/삭제/목록 버튼 ------------------------------>
            ...
            <button type="button" class="btn btn-secondary" onclick="location.href='<%=contextPath%>/detailsemi.no?ujBno=<%=n.getNoticeNo()%>'">뒤로가기</button>
