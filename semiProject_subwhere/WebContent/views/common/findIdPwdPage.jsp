...
<body>
    ...
    <div id="header">
        ...
        <div id="header_4">
            ...
            <div id="usermenu_page" class="usermenu_page" style="display: none;"> <!-- Set display to none initially -->
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                ...
                                <form action="<%=contextPath%>/findPwd.me" method="post">
                                    <table>
                                        <tr>
                                            <td><input name="memberId" type="text" class="form-control" placeholder="아이디" required></td>
                                        </tr>
                                        <tr>
                                            <td><input name="email" type="text" class="form-control" placeholder="이메일" required></td>
                                        </tr>
                                        <tr>
                                            <td><input name="phone" id="phone" type="text" class="form-control" placeholder="휴대폰 번호" oninput="autoHyphen2(this);" maxlength="13" required></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: x-small;"><b>아이디, 이메일, 휴대폰 번호 모두 일치하셔야 합니다.</b></td>
                                        </tr>
                                        <tr>
                                            <td><button type="submit" class="btn btn-primary btn-block">비밀번호 찾기</button></td>
                                        </tr>
                                ...
                                <script>
                                // 자동 하이픈 함수(input text 아이디값 하므로 아이디값 필수)
    ...
    <div id="navigator">
        ...
        <ul class="nav nav-pills justify-content-center">
            <li class="nav-item">
                <a class="btn btn-light nav_tab_font" href="<%=contextPath%>" style="box-shadow: 0px 0px 4px #585858">홈</a>
            </li>
            <li class="nav-item">
