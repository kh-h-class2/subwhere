                        ...
                        <div class="find_id_or_pwd">
                            ...
                            <%}else { %>
                                ...
                                <div id="usermenu_page_change_pwd">
                                    ...
                                    <p align="center" style="font-size: small; color: #007fff;">
                                        <br>
                                        입력하신 정보가 모두 일치합니다. <br>
                                        새로운 비밀번호를 설정해주세요.
                                    ...
                                    <form action="<%=contextPath%>/updatePwd.me" method="post">
                                        ...
                                        <input type="hidden" name="memberId" value="<%= findPwdMem.getMemberId() %>">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <b>새로운 비밀번호</b>
                                                    <input type="password" name="updatePwd" class="form-control" placeholder="영문 대소문자, 숫자, 특수문자 조합 8~15자" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <b>새로운 비밀번호 확인</b>
                                                    <input type="password" name="checkPwd" class="form-control" placeholder="한번 더 입력해주세요" required>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><button class="btn btn-primary btn-block" onclick="return validatePwd();">변경하기</button></td>
                                            </tr>
