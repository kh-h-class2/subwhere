...
<body>
    ...
    <div class="UJ-wrap">
        ...
        <form action="<%=contextPath %>/faqUpdate.qa" method="post">
          
       <input type="hidden" name="qno" value="<%=q.getQaNo() %>" >
        
        <div id="UJ-notice-title" style="padding-left: 40px;">
                <h1>
                    <input type="text" name="fqaTitle" value="<%=q.getQuestion()%>" style="width:935px;">
                </h1>
               ...
               <div id="UJ-content">
                    <p style="padding-left: 40px;">
                        <textarea name="faqContent"  cols="120" rows="15" style="resize: none; padding-left: 15px;"><%=q.getAnswer() %></textarea>
                    </p>
            ...
            <div id="UJ-btn">
             ...
             <!------------------------------ 수정/삭제/목록 버튼 ------------------------------>
                ...
                <button type="button" class="btn btn-secondary" onclick="UJgotoBack();">뒤로가기</button>
        ...
        <hr>
	     ...
	     <script>
	     	function UJgotoBack(){
	     		location.href="<%=contextPath%>/detailsemi.qa?ujQno=<%=q.getQaNo()%>";
